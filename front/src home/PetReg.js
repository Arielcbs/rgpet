...
function PetReg(props){
    ...
    const { classes, handleSubmit, handleChange, handleChangeimg, form, fears, foods, drugs, isSubmitting } = props;
    ...
    const otherType = () => {
        if(props.petType === 'other'){ 
            return (
            <>
            <FormControl margin='normal' required fullWidth>
            <InputLabel htmlFor='petTypeOther'>Obs</InputLabel>
            <Input onChange={handleChange} value={props.petTypeOther} id='petTypeOther' name='petTypeOther' autoFocus />
            </FormControl>
            </>
            )
        }
        ...
        <Paper className={classes.paper}>
            ...
            <form onSubmit={handleSubmit} className={classes.form}>
                ...
                <FormControl margin='normal' required fullWidth>
                    ...
                    <Input onChange={handleChange} value={form.petName} id='petName' name='petName' autoFocus />
                </FormControl>
                <FormControl margin='normal' fullWidth>
                    <InputLabel htmlFor='nickname'>{nicknameText}</InputLabel>
                    <Input onChange={handleChange} value={form.nickname} id='nickname' name='nickname' autoFocus />
                </FormControl>
                <FormControl component="fieldset" required margin='normal'>
                    <FormLabel component="legend">{petTypeText}</FormLabel>
                    <RadioGroup aria-label="pettype" name="petType" value={form.petType} onChange={handleChange} row>
                ...
                <FormControl margin='normal' fullWidth>
                    ...
                    <Input onChange={handleChange} value={form.breed} id='breed' name='breed' autoFocus />
                </FormControl>
                <FormControl margin='normal' fullWidth>
                    <InputLabel htmlFor='food'>{foodText}</InputLabel>
                    <Input onChange={handleChange} value={form.food} id='food' name='food' autoFocus />
                </FormControl>
                <FormControl margin='normal' fullWidth>
                    <InputLabel htmlFor='favToy'>{favToyText}</InputLabel>
                    <Input onChange={handleChange} value={form.favToy} id='favToy' name='favToy' autoFocus />
                </FormControl>
                {showFears()}
                ...
                <FormControl margin='normal' fullWidth>
                    ...
                    <Input onChange={handleChange} value={props.drug} id='drug' name='drug' autoFocus />
                </FormControl>
