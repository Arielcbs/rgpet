        ...
        <Paper className={classes.paper}>
            ...
            <form  className={classes.form}>
                ...
                <FormControl margin='normal' required fullWidth>
                    ...
                    <Input id='fname' name='fname' value={fnamedb} autoFocus />
                </FormControl>
                <FormControl margin='normal' required fullWidth>
                ...
                <FormControl margin='normal' required fullWidth>
                    ...
                    <Input id='numaddress' name='numaddress' autoFocus />
                </FormControl>
                <FormControl margin='normal' required fullWidth>
                    <InputLabel htmlFor='pcode'>{pcode}</InputLabel>
                    <Input id='pcode' name='pcode' autoFocus />
                </FormControl>
                <FormControl margin='normal' required fullWidth>
                    <InputLabel htmlFor='tel'>{tel}</InputLabel>
                    <Input id='tel' name='tel' autoFocus />
                </FormControl>
